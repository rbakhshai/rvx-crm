...
export const ACCENTS: Record<AccentName, AccentClasses> = {
  amber: {
    ...
    heroGradient: "from-amber-100/80 via-amber-50/40 to-background dark:from-amber-500/[0.12] dark:via-amber-500/[0.04] dark:to-background",
  ...
  blue: {
    ...
    heroGradient: "from-blue-100/80 via-blue-50/40 to-background dark:from-blue-500/[0.12] dark:via-blue-500/[0.04] dark:to-background",
  ...
  indigo: {
    ...
    heroGradient: "from-indigo-100/80 via-indigo-50/40 to-background dark:from-indigo-500/[0.12] dark:via-indigo-500/[0.04] dark:to-background",
  ...
  green: {
    ...
    heroGradient: "from-green-100/80 via-green-50/40 to-background dark:from-green-500/[0.12] dark:via-green-500/[0.04] dark:to-background",
  ...
  emerald: {
    ...
    heroGradient: "from-emerald-100/80 via-emerald-50/40 to-background dark:from-emerald-500/[0.12] dark:via-emerald-500/[0.04] dark:to-background",
  ...
  yellow: {
    ...
    heroGradient: "from-yellow-100/80 via-yellow-50/40 to-background dark:from-yellow-500/[0.12] dark:via-yellow-500/[0.04] dark:to-background",
  ...
  gray: {
    ...
    heroGradient: "from-gray-200/70 via-gray-100/40 to-background dark:from-gray-500/[0.12] dark:via-gray-500/[0.04] dark:to-background",
  ...
  lime: {
    ...
    heroGradient: "from-lime-100/80 via-lime-50/40 to-background dark:from-lime-500/[0.12] dark:via-lime-500/[0.04] dark:to-background",
  ...
  pink: {
    ...
    heroGradient: "from-pink-100/80 via-pink-50/40 to-background dark:from-pink-500/[0.12] dark:via-pink-500/[0.04] dark:to-background",
