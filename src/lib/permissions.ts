...
export const ROLES: ReadonlyArray<{ value: Role; label: string; description: string }> = [
  ...
  // Pathway direction (Reza's BD Pathway doc): Level 1 = entry rung,
  // Level 3 = the top — opposite of the old senior-first numbering.
  { value: "bd_level_1",           label: "Acquisitions Level 1", description: "Lead Generator — entry seat. Cold call, qualify, submit." },
  { value: "bd_level_2",           label: "Acquisitions Level 2", description: "Acquisition Scout — collects financials pre-submission." },
  { value: "bd_level_3",           label: "Acquisitions Level 3", description: "Acquisition Partner — bridge to closer / UW tracks." },
